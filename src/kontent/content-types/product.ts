...
import { type Taxonomy } from '../taxonomies/taxonomy';
...
export type Product = IContentItem<{
     ...
     * Taxonomy (taxonomy)
     * Required: true
     * Id: fc57df55-d573-4e1a-b33d-b5311d9677be
     * Codename: taxonomy___categorizing_target_audience
     */
    taxonomy___categorizing_target_audience: Elements.TaxonomyElement<Taxonomy>;
